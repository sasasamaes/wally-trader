---
name: hmm-analyze
description: 'Wally Trader command: /hmm-analyze'
version: 1.0.0
metadata:
  openclaw:
    tags:
    ...
    - subagents
---
<!-- generated from system/commands/hmm-analyze.md by adapters/openclaw/transform.py -->
<!-- OpenClaw invokes via /hmm-analyze -->
