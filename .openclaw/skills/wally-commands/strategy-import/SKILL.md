...
description: Importa una estrategia desde YouTube/PDF/Twitter/texto y la convierte
  en reglas JSON ejecutables
version: 1.0.0
metadata:
  openclaw:
    tags:
    ...
    - subagents
---
<!-- generated from system/commands/strategy-import.md by adapters/openclaw/transform.py -->
<!-- OpenClaw invokes via /strategy-import -->
