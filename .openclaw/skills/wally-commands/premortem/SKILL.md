---
name: premortem
description: Pre-mortem estructurado antes de entrar — fuerza pensar qué mata el trade
  ANTES de ejecutar
version: 1.0.0
metadata:
  openclaw:
    ...
    - subagents
---
<!-- generated from system/commands/premortem.md by adapters/openclaw/transform.py -->
<!-- OpenClaw invokes via /premortem -->
