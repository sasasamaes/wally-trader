---
name: punk-hunt
description: Caza autónoma de oportunidades en bitunix — escanea 10 cripto, elige
  el mejor setup ahora con metodología punkchainer, score ≥70 requerido [solo bitunix]
version: 1.0.0
metadata:
  hermes:
    tags:
    ...
    - subagents
---
<!-- generated from system/commands/punk-hunt.md by adapters/hermes/transform.py -->
<!-- Hermes invokes via /punk-hunt -->
