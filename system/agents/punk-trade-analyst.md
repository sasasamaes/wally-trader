...
description: Estrategia A backtested ganadora — VWAP Reversion + Multi-Timeframe Trend Filter. Usa SOLO indicadores estándar (no requiere Neptune privado). WR 57%, Profit Factor 3.31, avg duration 34 min. Selectiva por diseño (~4-5 setups/día universo). Auto-validación con macro_gate + Smart Money L/S confirmación. Use PROACTIVELY cuando profile=bitunix y user invoca /punk-trade.
