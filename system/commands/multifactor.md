---
description: Multi-Factor score 0-100 (Momentum + Volatility + Trend Quality + Volume). Meta-score complementario al ML XGBoost.
allowed-tools: Bash, mcp__tradingview__data_get_ohlcv, mcp__tradingview__chart_set_timeframe
---
