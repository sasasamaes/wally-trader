---
description: Position sizing basado en VaR/CVaR histórico (más adaptativo que flat 2%, se ajusta cuando ATR explota).
allowed-tools: Bash, mcp__tradingview__data_get_ohlcv, mcp__tradingview__chart_set_timeframe, Read
---
