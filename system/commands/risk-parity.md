---
description: Risk Parity sizing multi-asset (FTMO/fotmarkets). Filtra A-grade penalizando assets sobre-volátiles.
allowed-tools: Bash, mcp__tradingview__data_get_ohlcv, mcp__tradingview__chart_set_symbol, mcp__tradingview__chart_set_timeframe, Read
---
